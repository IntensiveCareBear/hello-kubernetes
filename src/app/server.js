...
var message = process.env.MESSAGE || "I don't know how to set up an env variable apparently";
...
var namespace = process.env.MY_POD_NAMESPACE || 'default';
...
var podHost = process.env.POD_HOST
